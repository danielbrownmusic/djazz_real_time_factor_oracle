...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 202.364133715629578, 636.18160597038991, 429.0, 24.610528663524519 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.635866284370422, -0.81839402961009, 429.0, 24.610528663524519 ],
					"varname" : "router",
					"viewvisibility" : 1
				}
