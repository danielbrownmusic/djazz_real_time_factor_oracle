...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.0, 18.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 407.5, 112.0, 93.0, 22.0 ],
					"text" : "route NONE"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 481.5, 168.0, 31.0, 22.0 ],
					"text" : "#1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 407.5, 168.0, 29.5, 22.0 ],
					"text" : "set"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "NONE", "" ],
									"patching_rect" : [ 90.5, 278.0, 59.0, 22.0 ],
									"text" : "t NONE s"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 50.0, 333.0, 99.5, 35.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 90.5, 203.0, 71.0, 22.0 ],
									"text" : "unpack s -1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 90.5, 152.0, 39.0, 22.0 ],
									"text" : "$2 $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 90.5, 100.0, 113.5, 22.0 ],
									"text" : "pack -1 s"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 152.0, 251.5, 59.5, 251.5 ],
									"source" : [ "obj-24", 1 ]
								}
...
,
					"patching_rect" : [ 268.5, 546.0, 113.5, 22.0 ],
...
,
					"patching_rect" : [ 457.5, 546.0, 110.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "NONE", "clear", "clear" ],
					"patching_rect" : [ 31.0, 175.0, 109.0, 22.0 ],
					"text" : "t NONE clear clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.0, 335.5, 38.0, 22.0 ],
					"text" : "count"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.0, 635.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 31.0, 112.0, 162.0, 22.0 ],
					"text" : "route NONE"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.0, 175.0, 75.0, 62.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 183.5, 262.5, 183.5, 262.5 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"midpoints" : [ 130.5, 250.75, 183.5, 250.75 ],
					"source" : [ "obj-19", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 85.5, 446.5, 278.0, 446.5 ],
					"source" : [ "obj-19", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 40.5, 79.5, 417.0, 79.5 ],
					"order" : 0,
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 278.0, 587.0, 40.5, 587.0 ],
					"source" : [ "obj-31", 0 ]
				}
